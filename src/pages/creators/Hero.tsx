        ...
        <Container className={`hero hero-${theme}`}>
            {screenSize === 'desktop' || (screenSize === 'tablet' && orientation === 'landscape') ? (
                <>
                    ...
                    <p>
                        The no-code builder that supports complex startegies.
                        <br />
                        Build, test, automate and share with the community.
                    </p>
                    <Button>Join Us</Button>
                    <div className="stat">
                        <h3>
                            Create a bot and tap into the
                            <b> 950 wait-listed users </b>
                            who eager to
                            <b> copy your trading bot!</b>
                        </h3>
                    </div>
                </>
